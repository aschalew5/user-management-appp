...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            Row(
              ...
              children: [
                ElevatedButton.icon(
                  ...
                  onPressed: () {
                    // final Uri launchUri = Uri(scheme: 'tel', path: widget.user.phoneNumber);
                ...
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(50)),
                    backgroundColor: Theme.of(context).colorScheme.primary,
                    foregroundColor: Theme.of(context).colorScheme.onPrimary,    // ✅ ADD THIS LINE
      ...
      floatingActionButton: FloatingActionButton(
        heroTag: "btn3",
        onPressed: () async {
          final Uri launchUri = Uri(scheme: 'mailto', path: widget.user.email);
          await launchUrl(launchUri);
        },
        backgroundColor: Theme.of(context).colorScheme.primary,
  ...
  void _pickAndUploadImage() async {
    ...
    if (response.statusCode == 200) {
      ...
      await FirebaseFirestore.instance.collection('Users').doc(widget.user.uid).update({'img': imageUrl});
      setState(() {
